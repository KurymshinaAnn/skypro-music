            ...
            <div className={styles.bar__player_block}>
              <div className={styles.bar__player}>
                <div className={styles.player__controls}>
                  <div className={classNames(styles.player__btn_prev, styles.player__btn)}>
                    <svg className={styles.player__btn_prev_svg}>
                      <use href="img/icon/sprite.svg#icon-prev"></use>
                    </svg>
                  </div>
                  <div className={classNames(styles.player__btn_play, styles.player__btn, styles._btn)}>
                    <svg className={styles.player__btn_play_svg}>
                      <use href="img/icon/sprite.svg#icon-play"></use>
                    </svg>
                  </div>
                  <div className={classNames(styles.player__btn_next, styles.player__btn)}>
                    <svg className={styles.player__btn_next_svg}>
                      <use href="img/icon/sprite.svg#icon-next"></use>
                    </svg>
                  </div>
                  <div className={classNames(styles.player__btn_repeat, styles.player__btn, styles._btn_icon)}>
                    <svg className={styles.player__btn_repeat_svg}>
                      <use href="img/icon/sprite.svg#icon-repeat"></use>
                    </svg>
                  </div>
                  <div className={classNames(styles.player__btn_shuffle, styles.player__btn, styles._btn_icon)}>
